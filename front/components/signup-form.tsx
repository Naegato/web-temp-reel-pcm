...
export function SignupForm({
  ...
  const form = useForm({
    ...
    onSubmit: async ({ value }) => {
      try {
        // Extract confirmPassword from value since API doesn't need it
            ...
            <FieldGroup>
              ...
              <Field className="grid grid-cols-2 gap-4">
                ...
                <form.Field name="firstname">
                  {(field) => {
                    ...
                    return <Field data-invalid={isInvalid}>
                      <FieldLabel htmlFor={field.name}>Firstname</FieldLabel>
                      <Input
                        id={field.name}
                        name={field.name}
                        value={field.state.value}
              ...
              <Field>
                <Field className="grid grid-cols-2 gap-4">
                  ...
                  {/*</Field>*/}
                  {/*<Field>*/}
                  {/*  <Password id="confirm-password" name="confirm-password" label="Confirm Password" required/>*/}
                  {/*</Field>*/}
